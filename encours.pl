...
tourPlateau(Joueur, PJ1, PJ2, Case, NewPJ1, NewPJ2, NBGrainesRamassees, GrainesMain):- Joueur = 0, write('tour plateau1 0'), distribuerSurPlateau(0, Case,NombreDeGrainesCase,PJ1, NewPJ1, CaseArrivee, GrainesMain), CaseArrivee<0,
																						tourPlateau(1, NewPJ1, PJ2, Case, NewNewPJ1, NewPJ2, NBGrainesRamassees,GrainesMain).
tourPlateau(Joueur, PJ1, PJ2, Case, NewPJ1, NewPJ2, NBGrainesRamassees, GrainesMain):- Joueur = 1, write('TourPlateau1 1'), distribuerSurPlateau(1, 6, GrainesMain,PJ2, NewPJ2, CaseArrivee, NBGrainesRestantes), CaseArrivee<0,
...
tourPlateau2(Joueur, PJ1, PJ2, Case, NewPJ1, NewPJ2, NBGrainesRamassees, GrainesMain):- Joueur = 0, write('tourPlateau2 0'), distribuerSurPlateau2(0, Case,NombreDeGrainesCase,PJ1, NewPJ1, CaseArrivee, GrainesMain), CaseArrivee<0,
																						tourPlateau(1, NewPJ1, PJ2, Case, NewNewPJ1, NewPJ2, NBGrainesRamassees,GrainesMain).
