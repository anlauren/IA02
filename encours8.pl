...
%ajoute_element(element, liste, resultat) : ajoute element à liste
...
%distribuerSurPlateau(0, Case, NBGrainesCase, PJ1, NewPJ1, CaseArrivee, NBGrainesRestantes) va distribuer les graines de Case(=NBGrainesCase) dans PJ1(c'est-à-dire le plateau du joueur dont c'est le tour).
...
distribuerSurPlateau2( _, NBGrainesCase, PJ1, PJ1, CaseArrivee, 0):- 
														NBGrainesCase ==0,
														compte(PJ1, X), 
														 CaseArrivee is 6 - X, !.
